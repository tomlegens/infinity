 ...
 */
class CmsAceDependants {

    public function __construct() {
        add_action( 'tgmpa_register', array('CmsAceDependants', 'cmsace_register_required_plugins') );
    }

    public static function cmsace_register_required_plugins()
    {
        /*
        ...
        $plugins = array(
            ...
            array(
                'name' => 'Gravity Forms',
                'slug' => 'gravityforms',
                'source' => get_stylesheet_directory() . '/assets/functions/plugins/gravityforms.zip',
                'required' => false,
            ),
